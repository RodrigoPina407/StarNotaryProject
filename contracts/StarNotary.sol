...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(_exists(_tokenId1) && _exists(_tokenId2), "Invalid Tokens!");
        ...
        if(msg.sender == owner1){
            transferFrom(owner2, owner1, _tokenId2); //if owner 1 is not approved to transfer owner2's token the transaction ends
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Sender does not own this token!");
